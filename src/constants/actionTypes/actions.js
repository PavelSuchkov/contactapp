...
export const EDIT_CONTACT_LOADING = 'DELETE_CONTACT_LOADING'
export const EDIT_CONTACT_SUCCESS = 'DELETE_CONTACT_SUCCESS'
export const EDIT_CONTACT_FAILED = 'DELETE_CONTACT_FAILED'
